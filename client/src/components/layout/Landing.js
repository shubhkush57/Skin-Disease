    ...
    <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
      ...
      <div class="w-96 h-92 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-zinc-700 dark:border-gray-700">
          ...
          <div class="flex flex-col items-center pb-10">
              ...
              <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Skin Disease Detection</h5>
              <span class="text-sm text-gray-500 dark:text-gray-400">Welcome To Skin Disease Detection</span>
