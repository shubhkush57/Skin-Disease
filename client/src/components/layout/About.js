...
<div>
        <h1 className="text-3xl font-bold mb-4 text-center">Information About {renderResult()}</h1>
      </div>
      <div className="mt-4 w-full max-w-md">
        <select
          className="form-select w-full py-3 px-4 bg-white border border-gray-300 rounded-md shadow-md focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition duration-200"
          value={car}
          onChange={handleOnChange}
        >
          <option value="Select Disease" disabled>Select Disease Type</option>
